...
& $msbuildPath /Restore ./SpecFlow.VisualStudio.$VisualStudioVersion.sln /property:Configuration=$Configuration /binaryLogger:msbuild.$Configuration.binlog /nodeReuse:false
