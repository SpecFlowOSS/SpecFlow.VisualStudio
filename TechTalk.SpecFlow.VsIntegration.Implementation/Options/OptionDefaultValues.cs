...
{
    public class OptionDefaultValues
    {
        ...
        public const int DefaultLineBreaksBeforeScenario = 1;
        public const int DefaultLineBreaksBeforeExamples = 1;
        public const bool UseTabsForIndentDefaultValue = true;
        public const int DefaultFeatureIndent = 0;
        public const int DefaultScenarioIndent = 0;
        public const int DefaultStepIndent = 1;
