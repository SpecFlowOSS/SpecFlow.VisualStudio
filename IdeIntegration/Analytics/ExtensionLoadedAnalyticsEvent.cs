...
namespace TechTalk.SpecFlow.IdeIntegration.Analytics
{
    ...
    {
        public ExtensionLoadedAnalyticsEvent(DateTime utcDate, string userId, string ide, string ideVersion, string extensionVersion, IEnumerable<string> projectTargetFrameworks)
        {
            UtcDate = utcDate;
            UserId = userId;
            Ide = ide;
